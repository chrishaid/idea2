...
### Longitudinal Data (click and drag to select points to populate data table below)
...
### Details (click and drag to select assessmens above; scroll to see all data.)
...
selectInput("hs_sy", label = "Select School",
            choices = schoolyears,
