...
ew_data <- reactive({
  assesssment_summary %>%
    ...
    create_long_table(grade = input$grade_ew,
...
output$test_dt  <-  DT::renderDataTable({
  ...
  DT::datatable(table_data,
                ...
                class = 'cell-border table-condensed table-bordered'
                ) %>%
    DT::formatStyle(4:n_format_cols, backgroundColor = DT::styleInterval(60, c('red', 'forestgreen')),
                    color = "white")
})
